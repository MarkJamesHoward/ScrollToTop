...
class UpdatingElement extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.hasOwnProperty(JSCompiler_renameProperty('properties', this))) {
      ...
      for (var _i = 0, _propKeys = propKeys; _i < _propKeys.length; _i++) {
        const p = _propKeys[_i];
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            previousUpdatePromise = _this._updatePromise;
          ...
          case 10:
            ...
            _context.next = 13;
            return new Promise(res => _this._hasConnectedResolver = res);

          case 13:
            _context.prev = 13;
            result = _this.performUpdate(); // If `performUpdate` returns a Promise, we await it. This is done to
